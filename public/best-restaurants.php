<?php
/**
 * Best Restaurants collection page.
 */
...
$pageTitle = __('pages.best_restaurants.title', [], 'Best Restaurants in Puerto Rico');
$pageDescription = __('pages.best_restaurants.description', [], 'Find the best restaurants in Puerto Rico, from local criollo joints to fine dining with ocean views.');
$heroTitle = __('pages.best_restaurants.hero_title', [], 'Best Restaurants');
$heroSubtitle = __('pages.best_restaurants.hero_subtitle', [], 'Local flavors, ocean views, and unforgettable meals across the island.');
$canonicalPath = routeUrl('best_restaurants', $lang);
...
<section class="hero-gradient-dark relative py-16 px-4">
    <div class="max-w-6xl mx-auto text-center">
        ...
        <p class="text-white/60 mt-3"><?= number_format($result['total']) ?> restaurants found</p>
    </div>
</section>
