...
$pageTitle = __('pages.best_rivers.title', [], 'Best Rivers in Puerto Rico');
$pageDescription = __('pages.best_rivers.description', [], 'Discover the most beautiful rivers across Puerto Rico for swimming, tubing, and adventure.');
$heroTitle = __('pages.best_rivers.hero_title', [], 'Best Rivers');
$heroSubtitle = __('pages.best_rivers.hero_subtitle', [], 'Crystal-clear rivers, natural pools, and hidden swimming holes across the island.');
$canonicalPath = routeUrl('best_rivers', $lang);
...
<section class="hero-gradient-dark relative py-16 px-4">
    <div class="max-w-6xl mx-auto text-center">
        ...
        <p class="text-white/60 mt-3"><?= number_format($result['total']) ?> rivers found</p>
    </div>
</section>
...
<div class="max-w-6xl mx-auto px-4 py-8">
    ...
    <div id="place-results" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
        ...
        <div class="col-span-full text-center py-12 text-gray-400">
            <p>No rivers found matching your filters.</p>
        </div>
        <?php else: ?>
