<?php
/**
 * Best Photo Spots collection page.
 */
...
$placeType = 'photo_spot';
$lang = getCurrentLanguage();
$config = getPlaceTypeConfig($placeType);

$pageTitle = __('pages.best_photo_spots.title', [], 'Best Photo Spots in Puerto Rico');
$pageDescription = __('pages.best_photo_spots.description', [], 'Discover the most photogenic locations in Puerto Rico for stunning photography opportunities.');
$heroTitle = __('pages.best_photo_spots.hero_title', [], 'Best Photo Spots');
$heroSubtitle = __('pages.best_photo_spots.hero_subtitle', [], 'Capture the beauty of Puerto Rico at these stunning photography locations.');
$canonicalPath = routeUrl('best_photo_spots', $lang);
...
<section class="hero-gradient-dark relative py-16 px-4">
    <div class="max-w-6xl mx-auto text-center">
        ...
        <p class="text-white/60 mt-3"><?= number_format($result['total']) ?> photo spots found</p>
    </div>
</section>
...
<div class="max-w-6xl mx-auto px-4 py-8">
    ...
    <div id="place-results" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
        ...
        <div class="col-span-full text-center py-12 text-gray-400">
            <p>No photo spots found matching your filters.</p>
        </div>
        <?php else: ?>
