...
(function() {
    ...
    state.searchQuery = window.AJIApp?.searchQuery || '';
    ...
    window.updateResultsCount = function() {
        ...
        const count = state.filteredBeaches.length || window.AJIApp?.totalBeaches || 0;
